![Build Status](https://github.com/DiscipleTools/zume-funnel-metrics/actions/workflows/ci.yml/badge.svg?branch=master)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```zume_critical_path()```
...
[Issues](https://github.com/DiscipleTools/zume-funnel-metrics/issues) section of the repo. You can present ideas
in the [Discussions](https://github.com/DiscipleTools/zume-funnel-metrics/discussions) section of the repo. And
code contributions are welcome using the [Pull Request](https://github.com/DiscipleTools/zume-funnel-metrics/pulls)
system for git. For a more details on contribution see the
[contribution guidelines](https://github.com/DiscipleTools/zume-funnel-metrics/blob/master/CONTRIBUTING.md).
