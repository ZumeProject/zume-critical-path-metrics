...
class Zume_Critical_Path_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'zume-critical-path-metrics'; // lowercase
    public $base_title = 'Zúme Critical Path Metrics';
    ...
    public function scripts() {
        ...
        wp_localize_script(
            'dt_'.$this->slug.'_script', $this->js_object_name, [
                ...
                'translations' => [
                    'title' => $this->title,
                    'Sample API Call' => __( 'Sample API Call', 'zume-critical-path' )
                ]
            ]
        );
    }
