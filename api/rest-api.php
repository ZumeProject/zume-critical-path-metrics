        ...
        switch( $params['key'] ) {
            ...
            case 'countries':
                return [
                    ...
                    'link' => '',
                    'value' => Zume_Query::format_int( $value ),
                    'valence' => Zume_Query::get_valence( $value, $trend, $negative_stat ),
                    'goal' => 0,
                    'goal_valence' => 'valence-grey',
                    'goal_percent' => 0,
                    'trend' => $trend,
        ...
        switch( $params['key'] ) {
            ...
            default:
                return [
                    ...
                    'description' => 'People who are seeking multiplicative movement and are partially skilled with the coaching checklist.',
