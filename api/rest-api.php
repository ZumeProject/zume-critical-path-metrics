...
class Zume_Stats_Endpoints
{
        ...
        switch( $params['key'] ) {
            ...
            case 'visitors':
                return [
                    ...
                    'link' => '',
                    'value' => Zume_Funnel_Query::format_int( $value ),
                    'valence' => Zume_Funnel_Query::get_valence( $value, $goal, $negative_stat ),
                    'goal' => $goal,
                    'goal_valence' => Zume_Funnel_Query::get_valence( $value, $goal, $negative_stat ),
                    'goal_percent' => Zume_Funnel_Query::get_percent( $value, $goal ),
                    'trend' => $trend,
    ...
    public function add_registrants_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 'registrants',
            'label' => __( 'Registrants', 'zume_funnels' )
        ];
    ...
    public function add_active_training_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 'active_training',
            'label' => __( 'Active Training', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function add_post_training_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 'post_training',
            'label' => __( 'Post Training', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function add_s1_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 's1',
            'label' => __( 'Partial Practitioner', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function add_s2_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 's2',
            'label' => __( 'Completed Practitioner', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function add_s3_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 's3',
            'label' => __( 'Multiplying Practitioner', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function add_practitioners_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 'practitioners',
            'label' => __( 'Practitioners', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function add_churches_column( $data ) {
        ...
        $column_labels[ $next_column_number ] = [
            'key'   => 'churches',
            'label' => __( 'Churches', 'zume_funnels' )
        ];
        if ( ! empty( $column_data ) ) {
            foreach ( $column_data as $key => $value ) {
                $column_data[$key][$next_column_number] = 0;
    ...
    public function list( WP_REST_Request $request ) {
        return Zume_Funnel_Query::trainees_list( dt_recursive_sanitize_array( $request->get_params() ) );
    }
    public function log( WP_REST_Request $request ) {
        return Zume_Funnel_Query::log( dt_recursive_sanitize_array( $request->get_params() ) );
    }
